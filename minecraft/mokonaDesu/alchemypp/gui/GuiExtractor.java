...
public class GuiExtractor extends GuiContainer {
        ...
        public GuiExtractor (InventoryPlayer inventoryPlayer,
        ...
        protected void drawGuiContainerBackgroundLayer(float par1, int par2,
                ...
                if (percentage <= 36) this.drawTexturedModalRect(x + 70, y + 35 - (percentage / 2), 176, 2, 1, (percentage / 2));	
                else this.drawTexturedModalRect(x + 70, y + 17, 176, 2, 1, 18);
