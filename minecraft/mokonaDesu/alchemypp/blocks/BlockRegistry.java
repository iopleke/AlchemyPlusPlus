...
public class BlockRegistry {
    ...
    public static final Block appBlockOrichalcumOre = new BlockOre(
    ...
    public static void registerBlockRecipes() {
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                appBlockOrichalcum, 1, 0), "xxx", "x x", "xxx", 'x',
                ItemRegistry.oreDictOrichalcum));
        GameRegistry.addShapelessRecipe(new ItemStack(
                ItemRegistry.appItemOrichalcumBar, 8, 0), new ItemStack(
                appBlockOrichalcum));
