...
public class APPConfigurator {
	...
	public static void loadConfig(FMLPreInitializationEvent e) {
		...
		Property worldGenOre = alchemyPPConfig.get(Configuration.CATEGORY_GENERAL, "generateOrichalcum", true);
		...
		Property alternativeTextures = alchemyPPConfig.get(Configuration.CATEGORY_GENERAL, "alternativeTextures", false);
		AlchemyPP.alternativeTextures = alternativeTextures.getBoolean(false);
		alternativeTextures.comment = "Enables Alchemy++ alternative textures for Orichalcum and related items. " +
				"These are slightly more green and look better with Metallurgy 2 version of the Orichalcum.";
