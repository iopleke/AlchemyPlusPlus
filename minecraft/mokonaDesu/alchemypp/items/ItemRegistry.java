...
public class ItemRegistry {
    ...
    public static final Item appItemFarina = new APPItem(
            APPIDManager.nextItemID(), "AlchemyPP:Farina")
            .setCreativeTab(CreativeTabs.tabMaterials);

    // version 1.1a

    public static final Item appItemGuide = new ItemAlchemicalGuide(
            APPIDManager.nextItemID(), "AlchemyPP:Farina")
            .setCreativeTab(AlchemyPP.alchemyPPTab);
    ...
    public static void registerItems() {
        ...
        GameRegistry.addSmelting(appItemOrichalcumOre.itemID, new ItemStack(
                appItemOrichalcumBar.itemID, 1, 0), 10);
    ...
    public static void registerItemRecipes() {
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(
                ...
                new ItemStack(BlockRegistry.appBlockOrichalcum)));

        GameRegistry.addShapelessRecipe(new ItemStack(appItemFarina, 1, 0),
                new ItemStack(Item.potato));
        GameRegistry.addShapelessRecipe(new ItemStack(appItemSpirit, 1, 0),
                new ItemStack(Item.sugar), new ItemStack(
                        ItemRegistry.appItemFarina));
