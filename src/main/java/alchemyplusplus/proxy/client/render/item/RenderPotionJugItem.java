...
public class RenderPotionJugItem implements IItemRenderer
{
    private final ModelPotionJug modelPotionJug;

    public RenderPotionJugItem()
    {
        this.modelPotionJug = new ModelPotionJug();
    }
