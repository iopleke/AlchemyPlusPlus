...
public class RenderLiquidMixerItem implements IItemRenderer
{
    private final ModelLiquidMixer modelLiquidMixer;

    public RenderLiquidMixerItem()
    {
        this.modelLiquidMixer = new ModelLiquidMixer();
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data)
    {
        ...
        this.modelLiquidMixer.render((Entity) null, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 1);
